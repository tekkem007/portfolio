...
export const MEDIA = [
  ...
  },
  {
    ...
    w: 1919,
    h: 1028,
    alt: 'The BP_Array Blueprint open in Unreal: a construction script that reads locations along a spline and places instanced static meshes at them.',
  },
  {
    id: 'hangar-03',
    ...
    w: 1919,
    h: 1034,
    alt: 'Unlit view of the hangar interior, showing the modular kit, the gantry towers and the curved transit tube as untextured geometry.',
  },
  ...
  },
  {
    ...
    w: 1474,
    h: 897,
    alt: 'Unlit close-up of the ID mask in the Unreal viewport — flat colour regions that decide which material layer each part of the mesh receives.',
  },
  {
    id: 'material-03',
    ...
    w: 1913,
    h: 900,
    alt: 'The same viewport angle as the ID mask, now lit: the layered material resolved on the mesh, with the Details panel showing its single material slot.',
  },
  {
    id: 'material-04',
    ...
    w: 1919,
    h: 1032,
    alt: 'The MM_BaseLayer master material graph in Unreal, with the Stats panel reading 152 base-pass instructions, 119 vertex-shader instructions and 2 of 16 texture samplers.',
  },
  {
    id: 'material-05',
    ...
    w: 1918,
    h: 1031,
    alt: 'The MLB_ID material layer blend graph: an ID mask texture feeding a Blend Material Attributes node so its colour channels select between a top and bottom layer.',
  },
  {
    id: 'material-06',
    ...
    w: 1919,
    h: 1030,
    alt: 'The ML_LayerBase material layer graph — the node network every material layer in the system is built from.',
  },
  {
    id: 'material-07',
    ...
    w: 1919,
    h: 1030,
    alt: 'The MF_uvr material function graph, handling UV rotation, tiling and offset as reusable inputs.',
  },
  ...
  // live; clear the flag if they are ever posted.
  {
    ...
    w: 1920,
    h: 807,
    alt: 'The cave entrance lit by the Day preset: warm sunlight raking across pale rock, a tree and flowering grass in the foreground, and the circular latticed door in cool shadow.',
  },
  {
    id: 'tod-02',
    src: 'https://www.artstation.com/artwork/EzBAXq',
    ...
    w: 1920,
    h: 807,
    alt: 'The same camera and the same scene lit by the Night preset: deep blue moonlight across the rock face, the tree in silhouette, and the two door lamps casting warm pools onto the doorway.',
  },
  {
    id: 'tod-03',
  ...
  },
  {
    ...
    w: 1919,
    h: 1030,
    alt: 'The reactor hatch in Substance 3D Painter with the wireframe overlaid on the textured model, showing the topology under the surface.',
  },
  {
    id: 'fusion-cell-01',
  ...
  },
  {
    ...
    w: 1919,
    h: 1036,
    alt: 'The ARC-04 Fusion Cell in Substance 3D Painter with the wireframe and UV shells overlaid on the texture set.',
  },
  {
    id: 'gilded-relic-01',
  ...
  },
  {
    ...
    w: 1920,
    h: 1080,
    alt: 'A single hard-shell case rendered against a dark studio backdrop, showing the ribbed polycarbonate profile and the spinner wheels.',
  },
  {
    id: 'bmo-01',
